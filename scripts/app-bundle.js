define('app',['exports', 'aurelia-router', 'aurelia-framework', 'aurelia-auth', 'jquery', 'whatwg-fetch'], function (exports, _aureliaRouter, _aureliaFramework, _aureliaAuth) {
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_aureliaAuth.AuthService, _aureliaAuth.FetchConfig), _dec(_class = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: '', moduleId: 'patterns', title: '' }, { route: '/patterns', moduleId: 'patterns', title: 'Patterns', name: 'patterns' }, { route: '/pattern/:id', moduleId: 'pattern', name: 'pattern' }, { route: '/patterns/user/:id', moduleId: 'patternsByUser', name: 'patternsByUser' }, { route: '/designer', moduleId: 'designer', name: 'designer', title: 'Designer' }]);
...
define('designer',['exports', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-router', 'aurelia-auth', './app'], function (exports, _aureliaFramework, _aureliaFetchClient, _aureliaRouter, _aureliaAuth, _app) {
  'use strict';
  ...
  var Designer = exports.Designer = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, _aureliaRouter.Router, _aureliaAuth.AuthService, _app.App), _dec(_class = function () {
    function Designer(http, router, auth, app) {
    ...
    Designer.prototype.save = function save() {
      ...
      this.http.fetch('https://beader-api.herokuapp.com/patterns', {
        ...
        _this.saving = false;
        _this.router.navigateToRoute('pattern', { id: response._id });
...
define('pattern',['exports', 'aurelia-framework', 'aurelia-fetch-client', './app', 'aurelia-router'], function (exports, _aureliaFramework, _aureliaFetchClient, _app, _aureliaRouter) {
  'use strict';
  ...
  var Pattern = exports.Pattern = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, _app.App, _aureliaRouter.Router), _dec(_class = function () {
    function Pattern(http, app, router) {
      _classCallCheck(this, Pattern);

      this.pattern = {};
      this.userPatterns = [];
      this.totalUserPatterns = 0;
      this.userPatternsLimit = 10;
    ...
    Pattern.prototype.activate = function activate(params, routeConfig) {
      ...
      return this.http.fetch('https://beader-api.herokuapp.com/patterns/' + params.id).then(function (response) {
        ...
        _this.fetchUserPatterns(pattern.user._id);
      }).catch(function (err) {
        _this.errorMessage = 'Pattern not found.';
      });
    };
    ...
    Pattern.prototype.fetchUserPatterns = function fetchUserPatterns(userId) {
      ...
      return this.http.fetch('https://beader-api.herokuapp.com/patterns/user/' + userId + '?page=1&limit=' + this.userPatternsLimit).then(function (response) {
        ...
        _this2.userPatterns = response.patterns.filter(function (pattern) {
          ...
          return pattern._id !== _this2.pattern._id;
        });
        _this2.totalUserPatterns = response.totalPatterns;
      });
    };

    Pattern.prototype.delete = function _delete() {
      var _this3 = this;
...
define('patterns',['exports', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-router'], function (exports, _aureliaFramework, _aureliaFetchClient, _aureliaRouter) {
  ...
  var Patterns = exports.Patterns = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient), _dec(_class = function () {
    ...
    Patterns.prototype.activate = function activate(params, routeConfig) {
      var _this = this;
    ...
    PatternsByUser.prototype.activate = function activate(params, routeConfig) {
      ...
      this.http.fetch('https://beader-api.herokuapp.com/patterns/user/' + params.id + '?page=' + this.page + '&limit=' + this.limit).then(function (response) {
        ...
        if (_this.patterns.length) {
          routeConfig.navModel.setTitle('Patterns by ' + _this.patterns[0].user.displayName);
        }
...
define('resources/index',['exports'], function (exports) {
  ...
  function configure(config) {
    config.globalResources(['./elements/loadingIndicator']);
  }
});
define('resources/elements/loadingIndicator',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
  'use strict';
  ...
  var LoadingIndicator = exports.LoadingIndicator = (_class = function LoadingIndicator() {
    _classCallCheck(this, LoadingIndicator);

    _initDefineProp(this, 'loading', _descriptor, this);
  }, (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'loading', [_aureliaFramework.bindable], {
    enumerable: true,
...
define('text!resources/elements/loadingIndicator.html', ['module'], function(module) { module.exports = "<template style=\"display: block; text-align: center;\">\n  <img src=\"images/loading.gif\" style=\"margin: 30px 0;\" width=\"60\" height=\"60\" class=\"loading-indicator\" if.bind=\"loading\"></div>\n</template>"; });
