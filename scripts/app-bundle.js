...
define('designer',['exports', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-router', 'aurelia-auth'], function (exports, _aureliaFramework, _aureliaFetchClient, _aureliaRouter, _aureliaAuth) {
  'use strict';
  ...
  var Designer = exports.Designer = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, _aureliaRouter.Router, _aureliaAuth.AuthService), _dec(_class = function () {
    function Designer(http, router, auth) {
