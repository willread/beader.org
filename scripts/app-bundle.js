...
define('designer',["exports"], function (exports) {
  "use strict";
  ...
  var Designer = exports.Designer = function () {
    ...
    Designer.prototype.fill = function fill($event, x, y) {
      var oldColor = this.data[x + "x" + y] || this.clearColor;
      ...
      while (stack.length) {
        ...
        this.data[_x + "x" + _y] = this.color;

        if (_x - 1 >= 0 && oldColor == (this.data[_x - 1 + "x" + _y] || "ffffff")) stack.push([_x - 1, _y]);

        if (_x + 1 < this.width && oldColor == (this.data[_x + 1 + "x" + _y] || "ffffff")) stack.push([_x + 1, _y]);

        if (_y - 1 >= 0 && oldColor == (this.data[_x + "x" + (_y - 1)] || "ffffff")) stack.push([_x, _y - 1]);

        if (_y + 1 < this.height && oldColor == (this.data[_x + "x" + (_y + 1)] || "ffffff")) stack.push([_x, _y + 1]);
      }
    ...
    Designer.prototype.save = function save($event) {
